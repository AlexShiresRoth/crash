...
import { submitShippingInfo } from "../../../redux/actions/store";
    ...
    <div className={style.form_container}>
      <div className={style.form_header}>
        ...
        {shippingErrors.length > 0
          ? alerts.map((alert, i) => (
              <StoreAlert status={alert.msg} key={i} type={alert.alertType} />
            ))
          : null}
      </div>
...
export default connect(mapStateToProps, { submitShippingInfo })(
  ShippingAddressForm
);
